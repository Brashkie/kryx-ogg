 ...
 *
 * Written in CommonJS (require) because the package is `"type": "commonjs"`,
 * so a `.js` script is treated as CommonJS. Runs AFTER tsup, wired into
 * `build:ts` as `tsup && node scripts/fix-dts.js`.
 */
